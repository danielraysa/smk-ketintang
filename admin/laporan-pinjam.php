...
$result=mysqli_query($koneksi,"SELECT * FROM trans_pinjam WHERE status='kembali' ORDER BY id") or die(mysqli_error($koneksi));
...
$pdf->Cell(80);
$pdf->Cell(30,10,'LAPORAN TRANSAKSI',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
