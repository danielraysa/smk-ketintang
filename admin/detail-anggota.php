...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <td rowspan="6"><div class="pull-right image">
                            <img src="<?php echo $data['foto']; ?>" class="img-rounded" height="200" width="150" alt="User Image" style="border: 3px solid #333333;" />
                        </div></td>
                    </tr>
                    <tr>
                    <td width="250">No Induk</td>
                    <td width="500"><?php echo $data['no_induk']; ?></td>
                    </tr>
                    <tr>
                    <td>Nama</td>
                    ...
                    <tr>
                    <td>Password</td>
                    <td colspan="2"><?php echo $data['password']; ?></td>
                    </tr>
                   </table>
