                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
                                    $a = $_SESSION['no_induk'];
                    $query1="select data_buku.*, trans_pinjam.* from data_buku, trans_pinjam WHERE data_buku.id=trans_pinjam.id_peminjam AND trans_pinjam.status='pinjam' AND trans_pinjam.nama_peminjam='$a'";
